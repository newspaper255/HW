...
namespace HW5app1
{
    internal class Program
    {
        ...
        {
                const string sourceFileName = @"D:\HW\HW6\HW5app1\Archive.zip";
                const string destDirectName = @"D:\HW\HW6\HW5app1\DirForArchive";
                const string infoFileName = @"D:\HW\HW6\HW5app1\Info.csv";
                ...
                {
                    Console.WriteLine($"Error write .csv: {ex.Message}");
                }
